---
name: commented-dangerous-commands
description: Cleans build artefacts from the project directory. Use when the user asks to clean the build.
---

# Commented Dangerous Commands
